      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="top">
          <div class="back" @click="back">
            <img src="../../assets/images/below.png" class="icon-back">
          </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control" @click.stop="showPlayList">
          <img src="../../assets/images/list.png" class="icon-playlist" alt="">
        </div>
      </div>
    </transition>
...
<script>
  ...
  import ProgressBar from '../../functions/progressBar/progressBar'
  import animations from 'create-keyframe-animation'
  import ProgressCircle from '../../functions/progressCircle/progressCircle'
